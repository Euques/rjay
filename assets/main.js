				...
				sections = {
					'about': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-129362024-3', { 'page_path': '/#about' });
								},
							],
						},
					},
					'work': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-129362024-3', { 'page_path': '/#work' });
								},
							],
						},
					},
					'contact': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-129362024-3', { 'page_path': '/#contact' });
								},
							],
						},
					},
					'contact-done': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-129362024-3', { 'page_path': '/#contact-done' });
								},
							],
						},
					},
					'qr': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-129362024-3', { 'page_path': '/#qr' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'UA-129362024-3', { 'page_path': '/' });
								},
							],
						},
					},
